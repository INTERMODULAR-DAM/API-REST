...
router
    ...
    .patch('/userProfile', auth, multerUserUpload.single('file'), imageController.uploadUserPFP)
    .patch('/postPhotos', auth, multerPostUpload.array('files'), imageController.uploadPostPhotos)
//   .delete('userProfile')
//   .delete('/postPhotos')
